...
public class KeyanxiangmuController {
    ...
    public R page(@RequestParam Map<String, Object> params,KeyanxiangmuEntity keyanxiangmu,
		...
		if(tableName.equals("jiaoshi")) {
			keyanxiangmu.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = keyanxiangmuService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = keyanxiangmuService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = keyanxiangmuService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,KeyanxiangmuEntity keyanxiangmu, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("jiaoshi")) {
            keyanxiangmu.setJiaoshizhanghao((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<KeyanxiangmuEntity> ew = new EntityWrapper<KeyanxiangmuEntity>();
        int count = keyanxiangmuService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, keyanxiangmu), params), params));
